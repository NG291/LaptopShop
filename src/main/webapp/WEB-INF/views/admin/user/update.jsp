        ...
        <div class="col-md-6 col-12 mx-auto">
            ...
            <form:form method="post" action="/admin/user/update" modelAttribute="userUpdate">
                ...
                <div class="mb-3">
                    ...
                    <form:input type="email" class="form-control" path="email" value="${user.email}" readonly="true"/>
                </div>
                <div class="mb-3">
                    <label class="form-label"> Password:</label>
                    <form:input type="password" class="form-control" path="password" value="${user.password}" readonly="true"/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <form:input type="text" class="form-control" path="fullName" value="${user.fullName}"/>
                </div>
                <div class="mb-3">
